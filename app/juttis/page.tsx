...
export default function JuttisPage() {
  const category = getCategoryByName('Juttis')
  ...
  return (
    <div className="w-full">
      ...
      <div className="container py-12 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="mb-8">
          <h2 className="text-2xl font-bold tracking-tight">All Juttis</h2>
          <p className="mt-2 text-muted-foreground">
            Discover our collection of handcrafted traditional juttis
          </p>
        </div>
        <SortFilter
