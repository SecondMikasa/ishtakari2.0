...
export default function PotlisPage() {
  const category = getCategoryByName('Potlis')
  ...
  return (
    <>
      ...
      <div className="container py-12 px-4 md:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-2xl font-bold tracking-tight">All Potlis</h2>
          <p className="mt-2 text-muted-foreground">
            Explore our collection of traditional potlis with modern designs
          </p>
        </div>
        <SortFilter
