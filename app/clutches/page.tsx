...
export default function ClutchesPage() {
  const category = getCategoryByName('Clutches')
  ...
  return (
    <>
      ...
      <div className="container py-12 px-4 md:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-2xl font-bold tracking-tight">All Clutches</h2>
          <p className="mt-2 text-muted-foreground">
            Discover our collection of elegant clutches for special occasions
          </p>
        </div>
        <SortFilter
